...
public class DateTimeOffsetTest
{
    ...
    {
        var dt = new DateTimeOffset(42211290812, Offset);
        var dt1 = dt + 3.t;
    ...
    {
        var dt = new DateTimeOffset(2025, 11, 15, 0, 0, 0, Offset);
        var dt1 = dt + 3.us;
    ...
    {
        var dt = new DateTimeOffset(2025, 8, 15, 0, 0, 0, Offset);
        var dt1 = dt + 3.M;
    ...
    public void FromT()
    {
        ...
        var dt = DateTimeOffset.From(ticks, Offset);
    ...
    public void FromYMD()
    {
        ...
        var dt = DateTimeOffset.From(years, months, days, Offset);
        Assert.Equal(new DateTimeOffset(2025, 11, 23, 0, 0, 0, Offset), dt);
    }
    [Fact]
    public void FromYMDHMS()
    {
        ...
        var dt = DateTimeOffset.From(years, months, days, hours, minutes, seconds, Offset);
        Assert.Equal(new DateTimeOffset(2025, 11, 23, 13, 23, 42, Offset), dt);
    }
    [Fact]
    public void FromYMDHMSmsus()
    {
        ...
        var dt = DateTimeOffset.From(years, months, days, hours, minutes, seconds, millis, micros, Offset);
        Assert.Equal(new DateTimeOffset(2025, 11, 23, 13, 23, 42, 432, 745, Offset), dt);
    }
    ...
    {
        var dt = new DateTimeOffset(2025, 11, 15, 0, 0, 0, Offset);
        var offset = dt.To(out Years years, out Months months, out Days days);
    ...
    public void ToHMS()
    {
        ...
        var offset = dt.To(out Hours hours, out Minutes minutes, out Seconds seconds);
    ...
    {
        var dt = new DateTimeOffset(2025, 11, 15, 13, 23, 45, Offset);
        var offset = dt.To(out Years years, out Months months, out Days days, out Hours hours, out Minutes minutes, out Seconds seconds);
        Assert.Equal(2025, years.Value);
        Assert.Equal(11, months.Value);
        Assert.Equal(15, days.Value);
        Assert.Equal(13, hours.Value);
    ...
    public void ToYMDHMSmsus()
    {
        ...
        var offset = dt.To(out Years years, out Months months, out Days days, out Hours hours, out Minutes minutes, out Seconds seconds, out Milliseconds milliseconds, out Microseconds microseconds);
        Assert.Equal(2025, years.Value);
        Assert.Equal(11, months.Value);
        Assert.Equal(15, days.Value);
        Assert.Equal(13, hours.Value);
